...
export const mockProducts: Item[] = [
  ...
  { id: 'prod-7', name: 'Korean Beef Bulgogi', description: 'Marinated beef, sautéed with kimchi, served with steamed rice', price: 17.99, image: 'https://images.pexels.com/photos/3208566/pexels-photo-3208566.jpeg?auto=compress&cs=tinysrgb&w=400', categoryId: 'cat-6', categoryName: 'Main Courses', branchId: '1', isAvailable: true, isFeatured: true, sku: 'KR-001', unit: 'each', restaurantName: 'Seoul Kitchen', shortDescription: 'Marinated beef, kimchi, rice, traditional...', dietaryTags: ['spicy'], deliveryTime: 22, rating: 4.7, reviewCount: 334 },
  { id: 'prod-8', name: 'Caesar Salad with Grilled Chicken', description: 'Romaine lettuce, parmesan, house-made croutons, grilled chicken breast', price: 13.99, image: 'https://images.pexels.com/photos/1092730/pexels-photo-1092730.jpeg?auto=compress&cs=tinysrgb&w=400', categoryId: 'cat-6', categoryName: 'Salads', branchId: '1', isAvailable: true, isFeatured: false, sku: 'SA-001', unit: 'each', restaurantName: 'Fresh Greens Co', shortDescription: 'Romaine, parmesan, croutons, grilled chicken...', dietaryTags: ['glutenFree'], deliveryTime: 12, rating: 4.6, reviewCount: 156 },
  { id: 'prod-9', name: 'Chocolate Lava Cake', description: 'Warm chocolate cake with molten center, vanilla ice cream, berry coulis', price: 9.99, image: 'https://images.pexels.com/photos/312418/pexels-photo-312418.jpeg?auto=compress&cs=tinysrgb&w=400', categoryId: 'cat-6', categoryName: 'Desserts', branchId: '1', isAvailable: true, isFeatured: false, sku: 'DS-001', unit: 'each', restaurantName: 'Sweet Indulgence', shortDescription: 'Warm chocolate, molten center, ice cream...', dietaryTags: ['vegetarian'], deliveryTime: 10, rating: 4.9, reviewCount: 678 },
  { id: 'prod-10', name: 'Fresh Mango Smoothie', description: 'Ripe mango, coconut milk, Greek yogurt, honey', price: 8.99, image: 'https://images.pexels.com/photos/1092730/pexels-photo-1092730.jpeg?auto=compress&cs=tinysrgb&w=400', categoryId: 'cat-6', categoryName: 'Beverages', branchId: '1', isAvailable: true, isFeatured: true, sku: 'BV-001', unit: 'each', restaurantName: 'Juice Station', shortDescription: 'Ripe mango, coconut milk, yogurt, honey...', dietaryTags: ['vegan'], deliveryTime: 5, rating: 4.8, reviewCount: 412 },
  { id: 'prod-11', name: 'Organic Avocado Toast', description: 'Toasted sourdough, mashed avocado, cherry tomatoes, microgreens, sea salt', price: 11.99, image: 'https://images.pexels.com/photos/1092730/pexels-photo-1092730.jpeg?auto=compress&cs=tinysrgb&w=400', categoryId: 'cat-6', categoryName: 'Breakfast', branchId: '1', isAvailable: true, isFeatured: false, sku: 'BR-001', unit: 'each', restaurantName: 'Breakfast Club', shortDescription: 'Sourdough, avocado, tomatoes, microgreens...', dietaryTags: ['vegan'], deliveryTime: 8, rating: 4.7, reviewCount: 289 },
  { id: 'prod-12', name: 'Paneer Tikka Masala', description: 'Tandoori paneer cubes, tomato-cream sauce, naan bread, basmati rice', price: 14.99, image: 'https://images.pexels.com/photos/3916857/pexels-photo-3916857.jpeg?auto=compress&cs=tinysrgb&w=400', categoryId: 'cat-6', categoryName: 'Main Courses', branchId: '1', isAvailable: true, isFeatured: false, sku: 'IN-001', unit: 'each', restaurantName: 'Curry House', shortDescription: 'Tandoori paneer, tomato sauce, naan, rice...', dietaryTags: ['vegetarian', 'spicy'], deliveryTime: 32, rating: 4.8, reviewCount: 356 },
  { id: 'prod-13', name: 'Classic Burger & Fries', description: 'Grass-fed beef patty, cheddar, lettuce, tomato, special sauce, brioche bun', price: 16.99, image: 'https://images.pexels.com/photos/312418/pexels-photo-312418.jpeg?auto=compress&cs=tinysrgb&w=400', categoryId: 'cat-6', categoryName: 'Main Courses', branchId: '1', isAvailable: true, isFeatured: true, sku: 'BR-002', unit: 'each', restaurantName: 'Burger Bar', shortDescription: 'Grass-fed beef, cheddar, lettuce, sauce...', dietaryTags: [], deliveryTime: 18, rating: 4.7, reviewCount: 523 },
  ...
  { id: 'prod-15', name: 'Thai Green Curry', description: 'Green curry paste, coconut milk, Thai basil, bamboo shoots, jasmine rice', price: 15.49, image: 'https://images.pexels.com/photos/1092730/pexels-photo-1092730.jpeg?auto=compress&cs=tinysrgb&w=400', categoryId: 'cat-6', categoryName: 'Main Courses', branchId: '1', isAvailable: true, isFeatured: false, sku: 'TH-002', unit: 'each', restaurantName: 'Trattoria Roma', shortDescription: 'Green curry, coconut, basil, bamboo shoots...', dietaryTags: ['spicy', 'vegan'], deliveryTime: 24, rating: 4.8, reviewCount: 278 },
  { id: 'prod-16', name: 'Tiramisu', description: 'Layers of ladyfinger cookies, espresso, mascarpone, cocoa powder', price: 8.49, image: 'https://images.pexels.com/photos/312418/pexels-photo-312418.jpeg?auto=compress&cs=tinysrgb&w=400', categoryId: 'cat-6', categoryName: 'Desserts', branchId: '1', isAvailable: true, isFeatured: true, sku: 'DS-002', unit: 'each', restaurantName: 'Dolce Vita', shortDescription: 'Ladyfingers, espresso, mascarpone, cocoa...', dietaryTags: ['vegetarian'], deliveryTime: 8, rating: 4.9, reviewCount: 445 },
];
